...
将 `server/` 目录下的文件上传到 `img.7tan.cn`：

```
api/7tan_ping.php  →  https://img.7tan.cn/api/7tan_ping.php
7tan_stats.php     →  https://img.7tan.cn/7tan_stats.php
```
...
```
https://img.7tan.cn/api/7tan_ping.php?id=test123456789012&ver=5.1.0
```
