...
class Sidebar(QFrame):
    ...
    def __init__(self, user_info: dict | None = None):
        ...
        import re as _re4
        _site_root4 = _re4.sub(r"^(https?://)(?:img|cdn|api)\.", r"\1www.", _site_root4)
...
class SettingsPage(QWidget):
    ...
    def __init__(self, user_info: dict | None = None):
        ...
        self._provider_urls = {
            ...
            "sensetime": "https://token.sensenova.cn/v1",
    ...
    def _build_about_tab(self):
        ...
        try:
            ...
            _site_root_policy = _re_policy.sub(r"^(https?://)(?:img|cdn|api)\.", r"\1www.", _site_root_policy)
        except Exception:
