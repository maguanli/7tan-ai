...
# 1. 点击"文章"Tab（绝对坐标 (1782,172) → 窗口相对 → 物理 -8+1782, -8+172）
ax, ay = 1774, 164
pyautogui.click(ax, ay)
time.sleep(2.5)
print(f"[CLICK] 文章 Tab ({ax},{ay})")

# 2. OCR 结果页（右侧区域 x>1400）
img = grab()
img.save(r"D:\7tan\7tanAI\data\screenshots\article_tab.png")
print("\n=== 点击文章后 右侧区域 OCR ===")
for t, r in ocr(img, 2, (1400, 40, 1936, 1056)):
    pos = f"({int(r.x/2)+1400},{int(r.y/2)+40})" if r else ""
    print(f"  {t} {pos}")
