...
img = grab()
img.save(r"D:\7tan\7tanAI\data\screenshots\stz_home_full.png")

print("=== 右侧区域 OCR (1300,40)-(1936,1056) ===")
for t, r in ocr(img, 2, (1300, 40, 1936, 1056)):
    x = int(r.x/2)+1300; y = int(r.y/2)+40
    print(f"  '{t}' ({x},{y})")
