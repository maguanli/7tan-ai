...
img = snap()
img.save(r'D:\7tan\7tanAI\tools\ocr_work\hot_list.png')
words, text = ocr_all(img)
with open(r'D:\7tan\7tanAI\tools\ocr_work\hot_list.txt', 'w', encoding='utf-8') as f:
    for wx, wy, ww, wh, wt in words:
        f.write(f"({wx},{wy},{ww},{wh}) | {wt}\n")
    f.write("\nFULL:\n" + text)
print("LINES:", len(words))
for wx, wy, ww, wh, wt in words[:70]:
