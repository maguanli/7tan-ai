...
def main():
    ...
    with mss.mss() as sct:
        ...
        img.save('data/screenshots/after_cover_click.png')
    text = asyncio.run(recognize('data/screenshots/after_cover_click.png'))
    print('=====AFTER COVER CLICK=====')
    print(text)
    print('=====END=====')
