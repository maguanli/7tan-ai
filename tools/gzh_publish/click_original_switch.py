...
def main():
    ...
    with mss.mss() as sct:
        mon = sct.monitors[1]
        region = {'left': mon['left'] + 300, 'top': mon['top'] + 480, 'width': 600, 'height': 120}
        img = sct.grab(region)
        img = Image.frombytes('RGB', img.size, img.rgb)
        img.save('data/screenshots/after_original_click.png')
    text = asyncio.run(recognize('data/screenshots/after_original_click.png'))
    print('=====AFTER CLICK 750,518=====')
    print(text)
    print('=====END=====')
