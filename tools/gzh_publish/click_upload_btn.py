...
def main():
    ...
    with mss.mss() as sct:
        ...
        img.save('data/screenshots/after_upload_click.png')
    text = asyncio.run(recognize('data/screenshots/after_upload_click.png'))
    print('=====AFTER UPLOAD CLICK=====')
    print(text)
    print('=====END=====')
