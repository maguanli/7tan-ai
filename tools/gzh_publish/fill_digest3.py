...
def main():
    ...
    with mss.mss() as sct:
        ...
        img.save('data/screenshots/digest_final.png')
    words = asyncio.run(ocr_words('data/screenshots/digest_final.png'))
