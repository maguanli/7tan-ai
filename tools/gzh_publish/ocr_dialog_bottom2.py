...
def main():
    ...
    inv.save('data/screenshots/dialog_bottom_enhanced.png')
    words = asyncio.run(ocr_words('data/screenshots/dialog_bottom_enhanced.png'))
    print('=====WORDS(offset 360,580, scale 3)=====')
    for text, x, y, w, h in words:
        print(f'{text!r} @ ({360+x//3},{580+y//3})')
    print('=====END=====')
